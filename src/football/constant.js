...
export const SETTINGS_SCORING_FORMAT_MAP = {
  ...
  19: { abbr: 'P2PT', label: '2pt Passing Conversion' },
  ...
  26: { abbr: 'R2PT', label: '2pt Rushing Conversion' },
  44: { abbr: 'REC2PT', label: '2pt Receiving Conversion' },
  41: { abbr: 'RECS', label: 'Receptions' },
  42: { abbr: 'REY', label: 'Receiving Yards' },
  43: { abbr: 'RETD', label: 'TD Reception' },
  53: { abbr: 'RECS', label: 'Receptions' },
  58: { abbr: 'TGT', label: 'Receiving Targets' },
  68: { abbr: 'FUM', label: 'Total Fumbles' },
  72: { abbr: 'FUML', label: 'Total Fumbles Lost' },
  74: { abbr: 'FG50', label: 'FG Made (50+ yards)' },
  77: { abbr: 'FG40', label: 'FG Made (40-49 yards)' },
  80: { abbr: 'FG0', label: 'FG Made (under 40 yards)' },
  86: { abbr: 'PAT', label: 'Each PAT Made' },
  88: { abbr: 'PATM', label: 'Each PAT Missed' },
  89: { abbr: 'PA0', label: '0 Points Allowed' },
  90: { abbr: 'PA1-6', label: '1-6 Points Allowed' },
  91: { abbr: 'PA7-13', label: '7-13 Points Allowed' },
  92: { abbr: 'PA14-17', label: '14-17 Points Allowed' },
  ...
  107: { abbr: 'AST', label: 'Assisted Tackles' },
  108: { abbr: 'SOLO', label: 'Solo Tackles' },
  109: { abbr: 'TOT', label: 'Total Tackles' },
  120: { abbr: 'PTSA', label: 'Points Allowed' },
  121: { abbr: 'PA18-21', label: '18-21 Points Allowed' },
  122: { abbr: 'PA22-27', label: '22-27 Points Allowed' },
  123: { abbr: 'PA28-34', label: '28-34 Points Allowed' },
  124: { abbr: 'PA35-45', label: '35-45 Points Allowed' },
  125: { abbr: 'PA45+', label: '45+ Points Allowed' },
  127: { abbr: 'YA', label: 'Yards Allowed' },
  128: { abbr: 'YA0-99', label: '0-99 Yards Allowed' },
  129: { abbr: 'YA100-199', label: '100-199 Yards Allowed' },
  130: { abbr: 'YA200-299', label: '200-299 Yards Allowed' },
  131: { abbr: 'YA300-349', label: '300-349 Yards Allowed' },
  132: { abbr: 'YA350-399', label: '350-399 Yards Allowed' },
  133: { abbr: 'YA400-449', label: '400-449 Yards Allowed' },
  134: { abbr: 'YA450-499', label: '450-499 Yards Allowed' },
  135: { abbr: 'YA500-549', label: '500-549 Yards Allowed' },
  136: { abbr: 'YA550+', label: '550+ Yards Allowed' },
